...
### 判定基準 (Criteria)
算出されたインパクト値 ($I$) に基づき、施策の普及度を以下のように判定します。

| インパクト値 ($I$) | 判定 | 状態 (Status) |
| :--- | :--- | :--- |
| **$I < 1.0$** | **誤差レベル** | たった1つの自治体すらカバーできていない。社会インフラとして機能していない。 |
| **$1.0 \le I < 10$** | **局所的** | 一部地域での実験段階、あるいは特定の層にしか届いていない。 |
| **$I \ge 10$** | **実効性あり** | 一定の普及が見られ、社会的な効果が計測可能なフェーズ。 |
