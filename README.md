...
### 判定基準 (v2.0)
算出されたインパクト値 ($I$) に基づき、施策の「社会実装ステージ」を判定します。

| インパクト値 ($I$) | 判定 | 意味 (Benchmark) |
| :--- | :--- | :--- |
| **$I < 1.0$** | **誤差レベル** | 論外。1自治体すらカバーできていない。 |
| **$I < 14$** | **局所的** | 実験段階。郵便局（全国2.4万局）の密度に達していない。 |
| **$I < 32$** | **基礎インフラ級** | 郵便局を超えたレベル。物理インフラとしては合格点。 |
| **$I < 700$** | **コンビニ級** | コンビニ（全国5.5万店）を超えたレベル。利便性が高い。 |
| **$I < 7,000$** | **普及フェーズ** | 人口の1%に到達。認知が広がり始めている。 |
| **$I \ge 7,000$** | **社会OS級** | 人口の10%に到達。なくてはならない社会基盤。 |
